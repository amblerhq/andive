...
export const ligthGreyAlpha = alpha => `rgba(221, 221, 221, ${alpha})`
export const mediumGrey = '#708c91'
export const darkGrey = '#054752'
export const darkGreyAlpha = alpha => `rgba(5, 71, 82, ${alpha})`
export const darkGreyShade = 'rgba(5, 71, 82, 0.2)'

export const berryBlue = '#00aff5'
export const berryBlueAlpha = alpha => `rgba(0, 175, 245, ${alpha})`
export const lettuceGreen = '#5dd167'
export const beetrootPurple = '#55468c'
export const lightBeetrootPurple = '#5E48AF'
export const ligthBeetrootPurpleAlpha = alpha => `rgba(94, 72, 175, ${alpha})`
